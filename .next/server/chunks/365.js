exports.id=365,exports.ids=[365],exports.modules={6345:(e,t,r)=>{Promise.resolve().then(r.bind(r,4801)),Promise.resolve().then(r.bind(r,1327))},7465:(e,t,r)=>{Promise.resolve().then(r.t.bind(r,2994,23)),Promise.resolve().then(r.t.bind(r,6114,23)),Promise.resolve().then(r.t.bind(r,9727,23)),Promise.resolve().then(r.t.bind(r,9671,23)),Promise.resolve().then(r.t.bind(r,1868,23)),Promise.resolve().then(r.t.bind(r,4759,23))},4801:(e,t,r)=>{"use strict";r.d(t,{default:()=>o});var a=r(326),n=r(6931);let s=process.env.GA_MEASUREMENT_ID;function o(){return(0,a.jsxs)(a.Fragment,{children:[a.jsx(n.default,{src:`https://www.googletagmanager.com/gtag/js?id=${s}`,strategy:"afterInteractive"}),a.jsx(n.default,{id:"ga4",strategy:"afterInteractive",children:`
  ...
  `;try{let r=await fetch(g,{method:"POST",headers:{"Content-Type":"application/json","X-Shopify-Storefront-Access-Token":h},body:JSON.stringify({query:t,variables:{handle:e}}),next:{revalidate:60}}),a=await r.text(),n=JSON.parse(a),s=n.data?.collectionByHandle;if(!s)return null;return{title:s.title,handle:s.handle,description:s.description,image:s.image?.src||void 0}}catch(e){return console.error("Error fetching collection by handle:",e),null}}async function f(e){let t=`
  ...
  `;try{let r=await fetch(g,{method:"POST",headers:{"Content-Type":"application/json","X-Shopify-Storefront-Access-Token":h},body:JSON.stringify({query:t,variables:{handle:e}}),next:{revalidate:60}}),a=await r.text(),n=JSON.parse(a);return n.errors&&console.error("Shopify GraphQL errors:",JSON.stringify(n.errors,null,2)),(n.data?.collectionByHandle?.products?.edges||[]).map(e=>({title:e.node.title,handle:e.node.handle,image:e.node.images.edges[0]?.node.originalSrc||""}))}catch(e){return console.error("Error fetching collection:",e),[]}}n().config();let m=process.env.SHOPIFY_STORE_DOMAIN||"",y=process.env.SHOPIFY_STOREFRONT_API_TOKEN||"",x=`https://${m}/api/2024-04/graphql.json`,S=new s.g6(x,{headers:{"X-Shopify-Storefront-Access-Token":y}}),v=(0,s.Ps)`
...
`;async function b(){let e=[],t=!0,r=null;for(;t;){let a=await S.request(v,{first:250,after:r}),n=a.products.edges.map(e=>e.node);e=e.concat(n),t=a.products.pageInfo.hasNextPage,r=a.products.pageInfo.endCursor}return e}async function N(e){let t=`
  ...
  `;try{let r=await fetch(x,{method:"POST",headers:{"Content-Type":"application/json","X-Shopify-Storefront-Access-Token":y},body:JSON.stringify({query:t,variables:{handle:e}}),next:{revalidate:60}}),a=await r.text(),n=JSON.parse(a);if(!n.data?.productByHandle)return console.error(`getProductByHandle: No product found for handle "${e}"`,n.errors||n),null;return n.data.productByHandle}catch(t){return console.error(`Error in getProductByHandle for handle "${e}":`,t),null}}async function w(e){let t=`
